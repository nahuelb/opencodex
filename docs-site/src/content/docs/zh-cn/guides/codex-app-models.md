...
| Cursor | 静态回退包含 `cursor/gpt-5.6-sol`、`cursor/gpt-5.6-terra`、`cursor/gpt-5.6-luna`（1,000,000），以及 Grok 4.5/4.6 的普通和 Fast 条目（256,000）。4.6 还提供 `xhigh`；实时账户发现会决定最终哪些条目仍然可见。 |
