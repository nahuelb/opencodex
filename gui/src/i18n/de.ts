...
export const de: Record<TKey, string> = {
  ...
  "logs.cache.all": "Alle",
  "logs.cache.hit": "Treffer",
  "logs.cache.miss": "Kein Treffer",
  "logs.cache.unknown": "Unbekannt",
  "logs.cache.summary": "Cache-Nutzung",
  "logs.cache.hitRate": "Anfragen mit Treffer",
  "logs.cache.reuseRate": "Wiederverwendete Eingabe",
  "logs.cache.scope": "Nur gefilterte, geladene Anfragen. Unbekannte Nutzung ist ausgeschlossen; Wiederverwendung wird nach Eingabetokens gewichtet.",
  "logs.cache.definition": "Treffer bedeutet gemeldete Cache-Lesezugriffe über null; kein Treffer bedeutet gemeldete null. Fehlende, geschätzte oder ungültige Nutzung bleibt unbekannt.",
  "logs.cache.readTokens": "{tokens} im Cache",
  "logs.cache.outcome": "Anbieterergebnis",
  "logs.cache.uncached": "Nicht wiederverwendete Eingabe",
  "logs.cache.writeNote": "Nicht wiederverwendete Eingabe umfasst Cache-Schreibvorgänge. Schreiben belegt keinen Treffer.",
  "logs.cache.astra": "Astra-Erhaltung",
  "logs.cache.sideChat": "Präfixwiederverwendung im Nebenchat",
  "logs.cache.matchedItems": "Übereinstimmende Eingabeelemente",
  "logs.cache.attempt": "Versuch",
  "logs.cache.local": "Lokale Cache-Diagnose",
  "logs.cache.localNote": "Lokale Entscheidungen belegen keinen Cache-Treffer beim Anbieter. Versuchsdaten werden separat angezeigt und nicht zu Anfragesummen addiert.",
