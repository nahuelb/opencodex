...
export const en = {
  ...
  "logs.cache.unknown": "Unknown",
  "logs.cache.summary": "Cache usage",
  "logs.cache.hitRate": "Request hit rate",
  "logs.cache.reuseRate": "Input reused",
  "logs.cache.scope": "Filtered, loaded requests only. Rates exclude unknown usage; input reuse is weighted by input tokens.",
  "logs.cache.definition": "Hit means reported cache reads exceed zero; miss means a reported zero. Missing, estimated, or invalid usage is unknown.",
  "logs.cache.readTokens": "{tokens} cached",
  "logs.cache.outcome": "Provider outcome",
  "logs.cache.uncached": "Input not reused",
  "logs.cache.writeNote": "Input not reused includes cache writes. Writes do not prove a cache hit.",
  "logs.cache.astra": "Astra preservation",
  "logs.cache.sideChat": "Side-chat prefix reuse",
  "logs.cache.matchedItems": "Matched input items",
  "logs.cache.attempt": "Attempt",
  "logs.cache.local": "Local cache diagnostics",
  "logs.cache.localNote": "These local decisions do not prove a provider cache hit. Attempt data is shown separately and is not added to request totals.",
