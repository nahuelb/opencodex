...
export const ja: Record<TKey, string> = {
  "logs.cache.label": "キャッシュ",
  "logs.cache.all": "すべて",
  "logs.cache.hit": "ヒット",
  "logs.cache.miss": "ミス",
  "logs.cache.unknown": "不明",
  "logs.cache.summary": "キャッシュ使用量",
  "logs.cache.hitRate": "リクエストヒット率",
  "logs.cache.reuseRate": "入力再利用率",
  "logs.cache.scope": "読み込み済みの絞り込み結果のみ。不明な使用量は率の計算から除外し、入力再利用率は入力トークン数で加重します。",
  "logs.cache.definition": "報告されたキャッシュ読み取りがゼロを超える場合はヒット、ゼロの場合はミスです。未報告、推定、無効な使用量は不明です。",
  "logs.cache.readTokens": "{tokens} キャッシュ済み",
  "logs.cache.outcome": "プロバイダーの結果",
  "logs.cache.uncached": "再利用されなかった入力",
  "logs.cache.writeNote": "再利用されなかった入力にはキャッシュ書き込みが含まれます。書き込みはヒットの証拠ではありません。",
  "logs.cache.astra": "Astra 保持",
  "logs.cache.sideChat": "サイドチャットのプレフィックス再利用",
  "logs.cache.matchedItems": "一致した入力項目",
  "logs.cache.attempt": "試行",
  "logs.cache.local": "ローカルキャッシュ診断",
  "logs.cache.localNote": "ローカルの判断はプロバイダーのキャッシュヒットを証明しません。試行データは別に表示し、リクエスト合計には加算しません。",
...
"common.discard": "破棄",
  ...
  "dash.visionOff": "オフ",
  "manualCompact.title": "手動圧縮",
  "manualCompact.description": "手動の /compact コマンドに使うモデルを選択します。自動圧縮と以降のメッセージは会話の設定を維持します。",
  "manualCompact.model": "圧縮モデル",
  "manualCompact.effort": "推論の強度",
  ...
  "manualCompact.comboWarning": "この設定では、手動の /compact のたびに会話の全内容が、フェイルオーバー先を含むコンボ {combo} のすべてのターゲット（{providers}）へ要約のために送信されます。",
  "manualCompact.comboProvidersUnknown": "設定済みのターゲットプロバイダー",
