...
export const ko: Record<TKey, string> = {
  ...
  "logs.cache.hit": "적중",
  "logs.cache.miss": "미적중",
  "logs.cache.unknown": "알 수 없음",
  "logs.cache.summary": "캐시 사용량",
  "logs.cache.hitRate": "요청 적중률",
  "logs.cache.reuseRate": "입력 재사용률",
  "logs.cache.scope": "불러온 요청의 필터 결과만 표시합니다. 알 수 없는 사용량은 비율에서 제외하며 입력 재사용률은 입력 토큰 수로 가중합니다.",
  "logs.cache.definition": "보고된 캐시 읽기가 0보다 크면 적중, 명시된 0이면 미적중입니다. 누락, 추정 또는 잘못된 사용량은 알 수 없음입니다.",
  "logs.cache.readTokens": "{tokens} 캐시됨",
  "logs.cache.outcome": "공급자 결과",
  "logs.cache.uncached": "재사용되지 않은 입력",
  "logs.cache.writeNote": "재사용되지 않은 입력에는 캐시 쓰기가 포함됩니다. 쓰기는 적중을 증명하지 않습니다.",
  "logs.cache.astra": "Astra 보존",
  "logs.cache.sideChat": "보조 채팅 접두사 재사용",
  "logs.cache.matchedItems": "일치하는 입력 항목",
  "logs.cache.attempt": "시도",
  "logs.cache.local": "로컬 캐시 진단",
  "logs.cache.localNote": "로컬 결정은 공급자의 캐시 적중을 증명하지 않습니다. 시도 데이터는 별도로 표시하며 요청 합계에 더하지 않습니다.",
...
"common.discard": "버리기",
  ...
  "dash.visionOff": "끔",
  "manualCompact.title": "수동 압축",
  "manualCompact.description": "수동 /compact 명령에 사용할 모델을 선택하세요. 자동 압축과 이후 메시지는 대화 설정을 유지합니다.",
  "manualCompact.model": "압축 모델",
  "manualCompact.effort": "추론 수준",
  ...
  "manualCompact.comboWarning": "이 설정을 사용하면 수동 /compact마다 전체 대화 내용이 장애 조치 대상을 포함한 콤보 {combo}의 모든 대상({providers})으로 요약을 위해 전송됩니다.",
  "manualCompact.comboProvidersUnknown": "구성된 대상 프로바이더",
