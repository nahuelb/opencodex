...
export const ru: Record<TKey, string> = {
  "logs.cache.label": "Кэш",
  "logs.cache.all": "Все",
  "logs.cache.hit": "Попадание",
  "logs.cache.miss": "Промах",
  "logs.cache.unknown": "Неизвестно",
  "logs.cache.summary": "Использование кэша",
  "logs.cache.hitRate": "Доля запросов с попаданием",
  "logs.cache.reuseRate": "Повторно использованный ввод",
  "logs.cache.scope": "Только загруженные запросы после фильтрации. Неизвестные данные исключены; доля повторного ввода взвешена по входным токенам.",
  "logs.cache.definition": "Попадание означает чтение из кэша больше нуля; промах — явно указанный ноль. Отсутствующие, оценочные или некорректные данные считаются неизвестными.",
  "logs.cache.readTokens": "{tokens} из кэша",
  "logs.cache.outcome": "Результат провайдера",
  "logs.cache.uncached": "Неповторный ввод",
  "logs.cache.writeNote": "Неповторный ввод включает запись в кэш. Запись не доказывает попадание.",
  "logs.cache.astra": "Сохранение Astra",
  "logs.cache.sideChat": "Повтор префикса побочного чата",
  "logs.cache.matchedItems": "Совпавшие элементы ввода",
  "logs.cache.attempt": "Попытка",
  "logs.cache.local": "Локальная диагностика кэша",
  "logs.cache.localNote": "Локальные решения не доказывают попадание в кэш провайдера. Данные попыток показаны отдельно и не прибавляются к итогам запросов.",
...
"common.discard": "Отбросить",
  ...
  "dash.visionOff": "Выкл",
  "manualCompact.title": "Ручное сжатие",
  "manualCompact.description": "Выберите модель для ручных команд /compact. Автоматическое сжатие и последующие сообщения сохраняют настройки разговора.",
  "manualCompact.model": "Модель сжатия",
  "manualCompact.effort": "Уровень рассуждений",
  ...
  "manualCompact.comboWarning": "С этой настройкой каждый ручной /compact отправляет полное содержимое разговора каждой цели комбо {combo} ({providers}), включая резервные цели, для составления сводки.",
  "manualCompact.comboProvidersUnknown": "его настроенные целевые провайдеры",
