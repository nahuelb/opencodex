...
wire defaults. Zen and Free presets identify as `opencodex` and share the
[opaque session mechanism](../transports/responses.md) with a separate Zen hash domain.
