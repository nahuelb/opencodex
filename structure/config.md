...
The experimental side-chat option uses the bounded [tool-reference history contract](runtime.md#desktop-tool-reference-history).
...
Zen, Free and Go Muse reasoning metadata follows the [catalog contract](catalog.md#opencode-muse-effort-ladders), with identity wire maps and no added default override.
